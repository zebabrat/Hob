...
function DropdownMenuLabel({
  ...
  // A plain div, not MenuPrimitive.GroupLabel: that primitive throws
  // ("MenuGroupContext is missing") unless it's rendered inside a
  // <Menu.Group>, which a standalone label (e.g. UserMenu's name/email
  // header) never is. This is a static caption, not a group heading — it
  // doesn't need Base UI's group semantics, just the same look.
  return (
    <div
